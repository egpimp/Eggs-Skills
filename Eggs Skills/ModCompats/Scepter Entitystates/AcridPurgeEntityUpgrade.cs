...
{
    class AcridPurgeEntityUpgrade : BaseState
    {
        //Skills++ modifiers
        ...
        private readonly float blightDamageCoefficient = 4.5f;
        //Deeprot coefficient
        private readonly float drDamageCoefficient = 7.5f;
        //Detonation radius
        ...
        private readonly float healthFraction = 0.15f;
        ...
        private readonly float poisonDamageCoefficient = 3f;
