...
namespace EggsSkills.Resources
{
    internal class LanguageTokens
    {
        ...
        internal static void AcridTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESPURGE_UPGRADE" + dSuffix, "<style=cIsUtility>+20%</style> radius and <style=cIsDamage>+10%</style> damage");
        ...
        internal static void ArtificerTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESZAPPORT_UPGRADE" + dSuffix, "<style=cIsUtility>+10%</style> distance and <style=cIsDamage>+20%</style> damage");
        ...
        internal static void BanditTokens()
        {
            ...
            LanguageAPI.Add(prefix + banditName.ToUpper() + "_" + "PRIMARY_MAGICBULLET" + dSuffix, "Fire a bullet that deals <style=cIsDamage>200% damage</style>, and <style=cIsUtility>ricochets</style> to " + Configuration.GetConfigValue(Configuration.BanditMagicbulletRicochets) + " nearby enem" + ((Configuration.GetConfigValue(Configuration.BanditMagicbulletRicochets) > 1) ? "ies" : "y") + " for <style=cIsDamage>60% of the previous hit's damage</style>.");
            if (skillsPlusLoaded) LanguageAPI.Add("ESMAGICBULLET_UPGRADE" + dSuffix, "<style=cIsDamage>+5%</style> damage per bounce and <style=cIsUtility>+1</style> bounce every 2 levels");
        ...
        internal static void CaptainTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESDEBUFFNADE_UPGRADE" + dSuffix, "<style=cIsDamage>+20%</style> damage and <style=cIsUtility>+1</style> stock per 2 levels");
        ...
        internal static void CommandoTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESCOMBATSHOTGUN_UPGRADE" + dSuffix, "<style=cIsUtility>+0.1</style> proc coefficient per bullet and <style=cIsUtility>+1</style> bullet per 2 levels");
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESDASH_UPGRADE" + dSuffix, "<style=cIsDamage>+10%</style> damage buff for 2 seconds after dashing");
        ...
        internal static void EngiTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESTESLAMINE_UPGRADE" + dSuffix, "<style=cIsDamage>+10%</style> damage, <style=cIsUtility>+10%</style> radius, and <style=cIsUtility>+1</style> pulses every 2 levels");
        ...
        internal static void HuntressTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESCLUSTERARROW_UPGRADE" + dSuffix, "<style=cIsUtility>+10%</style> explosion and bomblet damage and <style=cIsUtility>+1</style> bomblets");
        ...
        internal static void LoaderTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESSHIELDSPLOSION_UPGRADE" + dSuffix, "<style=cIsUtility>+10%</style> radius and <style=cIsHealing>+5%</style> max hp barrier returned");
        ...
        internal static void MercTokens()
        {
            ...
            if (skillsPlusLoaded) LanguageAPI.Add("ESSLASHPORT_UPGRADE" + dSuffix, "<style=cIsDamage>+20%</style> damage and <style=cIsUtility>+0.1</style> proc coefficient");
