    ...
    class DebuffGrenadeEntity : BaseState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (base.isAuthority)
            {
                ...
                ProjectileManager.instance.FireProjectile(EggsSkills.Resources.Projectiles.debuffGrenadePrefab,aimRay.origin,RoR2.Util.QuaternionSafeLookRotation(aimRay.direction),gameObject,damageStat * 2.5f,0,RollCrit());
            }
        }
